 ...
 * @Author: chenjj
 * @Date: 2018-01-29
 * @Description: 通过打印线程堆栈可以发现，JDK底层通过线程池ThreadPoolExecutor来执行回调通知，
 * 异步回调通知类由AsynchronousChannelGroupImpl实现，经过层层调用，最终回调completed方法。
 * 由此我们也可以得出结论：异步SocketChannel是被动执行对象，我们不需要像NIO编程那样创建一个独立的
 * IO线程来处理读写操作。
 */
