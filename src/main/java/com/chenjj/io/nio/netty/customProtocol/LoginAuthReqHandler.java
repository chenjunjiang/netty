 ...
 * @Author: chenjj
 * @Date: 2018-02-12
 * @Description: 在客户端和服务端TCP链路建立成功通道激活时发起握手请求；握手消息的接入和安全认证在服务端处理。
 */
public class LoginAuthReqHandler extends ChannelInboundHandlerAdapter {

  /**
   * 当客户端跟服务端经过TCP三次握手之后，由客户端构造握手请求消息给服务端，由于采用IP白名单认证机制，因此，不需要携带 消息体，消息体为空，消息类型为：握手请求信息。握手请求发送之后，按照协议规范，服务端需要返回握手应答消息。
   */
  @Override
